const {location,projectId,aiHelpers,clientProd,locationPath } = require('../helpers/aiHelpers');
...
const aiServices = {
    ...
    showProductSets: async (req, res) => {
        try{
            ...
            const [productSets] = await clientProd.listProductSets({parent: locationPath});
    ...
    getAllProducts : async(req,res)=>{
        ...
        try{
            ...
            const [products] = await clientProd.listProducts({parent: locationPath});
    ...
    deleteProductSet: async(req,res)=>{
            ...
            try{
                const productSetPath = clientProd.productSetPath(
                  ...
                  await clientProd.deleteProductSet({name: productSetPath});
